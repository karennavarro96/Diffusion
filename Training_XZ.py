...
model.add(tensorflow.keras.layers.Permute((1,3,2), input_shape=(row, col,ch)))
...
model.save_weights(cur_dir+ "ModelXZ.h5")
model_json = model.to_json()
with open(cur_dir+ "ModelXZ.json", "w") as json_file:
